...
<head>
  ...
  <title>Detail Pemesanan Cuci + Setrika</title>
...
<body>
  <form action="lihatPesanan.php" method="get">
    <?php
    $jumlahBj =  $_POST["jumlah-baju"] * 1500;
    $jumlahcln = $_POST["jumlah-celana"] * 1500;
    $jumlahjkt = $_POST["jumlah-jaket"] * 5000;
    $jumlahcd =  $_POST["jumlah-cd"] * 600;
    $jumlahslmt = $_POST["jumlah-selimut"] * 20000;
  ...
  <div class="flow-root rounded-lg border border-gray-100 py-3 shadow-sm">
    <dl class="-my-3 divide-y divide-gray-100 text-sm">
      ...
      <div class="grid grid-cols-1 gap-1 p-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4">
        ...
        <dd class="text-gray-700 sm:col-span-2">Cuci + Setrika</dd>
      </div>
    </dl>
  </div>
  <br>
    ...
    <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
      ...
      <tbody class="divide-y divide-gray-200">
        <tr>
          ...
          <td class="whitespace-nowrap px-4 py-2 text-gray-700 text-center">1.500</td>
        ...
        <tr>
          ...
          <td class="whitespace-nowrap px-4 py-2 text-gray-700 text-center">5.000</td>
        ...
        <tr>
          ...
          <td class="whitespace-nowrap px-4 py-2 text-gray-700 text-center ">600</td>
        ...
        <tr>
          ...
          <td class="whitespace-nowrap px-4 py-2 text-gray-700 text-center ">20.000</td>
