...
<body>
  ...
  <div class="flex justify-center ">
    ...
    <form action="jumlahsetrika.php" method="post" class="">
            ...
            <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
              ...
              <form class="mx-auto grid max-w-screen-md gap-4 sm:grid-cols-2" action="#" method="post">
                <div>
                  ...
                  <br><br>
                  <div class="flex justify-center">
                    <a href="jumlahsetrika.php"><button class="flex justify-center btn btn-wide btn-primary " name="cuker">Selesai</button></a>
                  </div>
                </div>
              </form>
              <!-- form - end -->
